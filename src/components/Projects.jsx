...
const projects = [
  {
    ...
    image: "/project_photos/match-a.png",
  ...
  },
  {
    ...
    award: null,
    description:
      "Skincare analysis app using Google Gemini API to generate structured AI skincare recommendations. Implemented Google OAuth to store scan history per user. Built during JourneyHacks 2026.",
  ...
  },
  {
    ...
    award: null,
    description:
      "Habit tracker you share with friends. AI generates tasks or you create your own, and you and your friends work together to take care of your Wedoo by completing tasks on time. Built for nwHacks 2026.",
    tech: [
      "React Native",
      "Expo",
      "TypeScript",
